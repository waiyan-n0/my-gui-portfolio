    ...
    return (
        <Reveal>
            <section className='p-8 md:px-16 max-w-7xl mx-auto'>
                <h1 className='text-xl font-bold border-b-2 border-amber-400 w-fit mb-4'>
                    {t('education.title')}
                </h1>
                <div className='flex items-center gap-4 group'>
                    ...
                    <div className='flex md:flex-row justify-between w-full gap-2'>
                        ...
                        <div className='text-sm font-semibold text-slate-500 md:text-right whitespace-nowrap'>
