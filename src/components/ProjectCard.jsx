...
const ProjectCard = ({ title, description, tags, githubLink, liveLink, delay }) => (
    <motion.div
        ...
        transition={{
            duration: 0.6,
            delay: delay, // ဤနေရာတွင် delay ကို သုံးထားပါတယ်
            ease: "easeOut"
        }}>
    <div className="flex flex-col p-6 bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl hover:border-amber-400 dark:hover:border-amber-400 transition-all duration-300 hover:-translate-y-2 group shadow-sm">
        <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-3 text-slate-500 dark:text-slate-400">
                ...
                {liveLink && (
                    <a
                        href={liveLink === "Processing" ? "#" : liveLink}
                        target={liveLink === "Processing" ? "_self" : "_blank"}
