const SkillBadge = ({ icon: Icon, name, hoverColor, percentage = 0 }) => {
    ...
    return (
        <div className="flex flex-col gap-1 px-3 py-1 rounded-xl bg-slate-100 dark:bg-slate-800/50 transition-all duration-300 group cursor-pointer
            ...
            <div className="flex flex-col gap-1.5 w-full">
                ...
                <div className="flex justify-between items-center font-semibold tracking-wider">
                    {/* Dynamic color class injected here */}
